...
jobjectArray GetFeatureList2(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_The Category2"), //Not counted
            OBFUSCATE("Toggle_The toggle"),
            OBFUSCATE(
                    "100_Toggle_True_The toggle 2"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_The toggle 3"), //This one too
...
jobjectArray GetFeatureList3(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_The Category3"), //Not counted
            OBFUSCATE("Toggle_The toggle"),
            OBFUSCATE(
                    "100_Toggle_True_The toggle 2"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_The toggle 3"), //This one too
...
jobjectArray GetFeatureList4(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_The Category4"), //Not counted
            OBFUSCATE("Toggle_The toggle"),
            OBFUSCATE(
                    "100_Toggle_True_The toggle 2"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_The toggle 3"), //This one too
...
jobjectArray GetFeatureList5(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_The Category5"), //Not counted
            OBFUSCATE("Toggle_The toggle"),
            OBFUSCATE(
                    "100_Toggle_True_The toggle 2"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_The toggle 3"), //This one too
...
jobjectArray GetFeatureList6(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category_The Category6"), //Not counted
            OBFUSCATE("Toggle_The toggle"),
            OBFUSCATE(
                    "100_Toggle_True_The toggle 2"), //This one have feature number assigned, and switched on by default
            OBFUSCATE("110_Toggle_The toggle 3"), //This one too
